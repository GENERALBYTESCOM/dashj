...
public abstract class Message {
    ...
    /**
     * Serialize this message to a byte array that conforms to the dash wire protocol.
     * <br/>
    ...
    /**
     * Serialize this message to the provided OutputStream using the dash wire format.
     *
     * @param stream
     * @throws IOException
     */
