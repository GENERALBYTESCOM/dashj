...
public class Wallet extends BaseTaggableObject
     ...
     * key, after loading a wallet produced by previous versions of dashj. If the wallet is encrypted the key
    ...
    /**
     * Returns the amount of dash ever received via output. <b>This is not the balance!</b> If an output spends from a
    ...
    /**
     * Returns the amount of dash ever sent via output. If an output is sent to our own wallet, because of change or
