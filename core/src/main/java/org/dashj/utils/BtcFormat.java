 ...
 * <code>"฿"</code>.
 *
 * <p>The denomination used when formatting will be either dash, millicoin
 ...
 * locale, a value of one dash might be formatted as <pre>฿1.00</pre> where a value
 ...
 * <code>1.0000 BTC</code>, or one dash, in millibitcoins, one shifts the decimal point
 ...
 * differently the same one-dash value:
 *
 * <blockquote><pre>
...
public abstract class BtcFormat extends Format {
    ...
    /**
     * Formats a dash monetary value and returns an {@link java.text.AttributedCharacterIterator}.
    ...
    /**
     * Formats a dash value as a number and possibly a units indicator and appends the
    ...
    /**
     * Formats a dash value as a number and possibly a units indicator to a
    ...
    /**
     * Takes a dash monetary value that the client wants to format and returns the number of
    ...
    /**
     * Takes an object representing a dash quantity of any type the
